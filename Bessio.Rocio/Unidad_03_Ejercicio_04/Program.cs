...
/*
                                            INVENTO ARGENTINO
                                      -----------------------------
                                       (Unidad 03 [POO], 31/08/22)
                  
 * CONSIGNA:
 *          En un proyecto de bibliotecas de clases, crear la clase Boligrafo a partir del 
 *          siguiente diagrama: 
 ...
 *          - La cantidad máxima de tinta para todos los bolígrafos será de 100. Generar una constante cantidadTintaMaxima en Boligrafo donde se guardará dicho valor.
            ...
            - El argumento tinta contedrá la cantidad de tinta a agregar o quitar. Podrá ser 
              positivo (cargar tinta) o negativo (gastar tinta).
            - Se deberá validar que el nivel de tinta resultante sea mayor o igual a cero y 
              menor o igual a cantidadTintaMaxima. Si no es válido, no se deberá modificar 
              el atributo ni realizar ninguna acción.
            ...
            - El método Pintar restará la tinta gastada (reutilizar código). El parámetro gasto 
              representará la cantidad de unidades de tinta a utilizar y utilizará tanta tinta 
              como tenga disponible sin quedar en negativo. Utilizando el parámetro dibujo 
    ...
    Agregar un proyecto de consola:
          - En el método Main, crear un bolígrafo de tinta azul (ConsoleColor.Blue) y 
            una cantidad inicial de tinta de 100 y otro de tinta roja (ConsoleColor.Red) y 
            50 de tinta.
...
namespace Unidad_03_Ejercicio_04
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ok = boli2.Pintar(70,out dibujp);

            Console.ForegroundColor = boli2.GetColor();
            Console.WriteLine($"OK: {ok}\nDIBUJO: {dibujp}");
            Console.ResetColor();
            Console.WriteLine($"{boli2.GetTinta()}");
